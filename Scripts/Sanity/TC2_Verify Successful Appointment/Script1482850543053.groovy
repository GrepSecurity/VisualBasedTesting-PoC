...
'Login to system using existing account'
WebUI.callTestCase(findTestCase('Sanity/Login'), ['Username' : 'John Doe', 'Password' : 'ThisIsNotAPassword'], 
    FailureHandling.STOP_ON_FAILURE)

'Fill in appointment\'s information'
if (true) {
...
'Verify \'Appointment Information\' page is displayed'
WebUI.verifyTextPresent('Appointment Confirmation', false)

'Verify appointment\'s information'
if (true) {
